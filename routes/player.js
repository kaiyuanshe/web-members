...
module.exports = {
  ...
  addPlayer: (req, res) => {
    ...
    db.query(
      "SELECT * FROM wechat_friends WHERE wechat_id='" +
        wechat_id +
        "' or nick_name='" +
        nick_name +
        "'",
        ...
        if (!err) {
          if (result.length > 0) {
            ...
            if (referee1 && referee2) {
              query =
                "INSERT INTO `users` (name, wechat_id, nick_name, github_name, referee1, referee2, " +
              ...
              query =
                "INSERT INTO `users` (name, wechat_id, nick_name, github_name, " +
                "work_group, position, introduce, status) VALUES ('" +
                name +
                "','" +
                wechat_id +
